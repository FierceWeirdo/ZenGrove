    ...
    <div id="mainBody">
        ...
        <div class="container" id=>
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="profileValueDisplays">
                        Total Medals of Achievement: <span id='zenMedals' class="userValues"></span> <img
                            src="ZenMedal.png" width=20px>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="deleteProfileModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
            aria-hidden="true">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == 1) {
                            ...
                            $('#changeUsernameResponse').html('');
                            $('#changeUsernameModal').modal('hide');
                        }
                        else if (response == 2) {
                            $('#changeUsernameResponse').html('Username format incorrect!');
                        }
                        else if (response == 3) {
                            $('#changeUsernameResponse').html('Username already taken!');
                        }
                    },
                    ...
                    <form action="controller_zengrove.php" method="POST">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <span id='changeUsernameResponse' style=''> </span>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary"
                                id='changeUsernameSubmitButton'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="setGoalTimeModal" tabindex="-1" role="dialog"
            aria-labelledby="setGoalTimeModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="controller_zengrove.php" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="dailyGoalTime"
                                    placeholder="Enter daily goal time" min="1" max="1440" required>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-primary"
                                id="changeDailyGoalSubmitButton">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <button type="button" class="btn btn-primary"
                                id="changePasswordSubmitButton">Submit</button> <span id='resultSpan'></span>
                        </form>
                    </div>
