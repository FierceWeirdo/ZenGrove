...
<body>
    <div id="mainBody">
            ...
            <div class="row">
                <div id="searchBar">
                    <form>
                        ...
                        <input id="searchUsernameInputBox" type="text" name="term"
                            placeholder="Search a new ZenMate with Username">
                        <img class="img-responsive" src="SearchIcon.png" id="searchIcon">
                    </form>
                </div>
                ...
                <div class="col-sm-9">
                    <div id="mainProfileAndChatDiv" class="container">
                        ...
                        <div id="friendProfileDiv">
                            ...
                            <p>Total ZenMedals of Achievement: <span id="zenMedals"></span> <img src="ZenMedal.png"
                                    width=20px> </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            $(document).on('click', '#friendsList tr', function () {
