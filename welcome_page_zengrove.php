            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="controller_zengrove.php" method="POST">
                        ...
                        if (isset ($_SESSION['SignUpUsernameError']) && $_SESSION['SignUpUsernameError']) {
                            echo "<script>  $('#signupModal').modal('show'); </script> <span style='font-size: 18px; color: white; font-style: italic;'>Username format incorrect!</span>";
